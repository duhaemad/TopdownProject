...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATopDownProjectGameMode_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_ATopDownProjectGameMode_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<ATopDownProjectGameMode>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ATopDownProjectGameMode_Statics::ClassParams = {
		...
		0,
		0x008802ACu,
		METADATA_PARAMS(Z_Construct_UClass_ATopDownProjectGameMode_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_ATopDownProjectGameMode_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_ATopDownProjectGameMode()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_ATopDownProjectGameMode_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(ATopDownProjectGameMode, 922080894);
	template<> TOPDOWNPROJECT_API UClass* StaticClass<ATopDownProjectGameMode>()
	{
		return ATopDownProjectGameMode::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ATopDownProjectGameMode(Z_Construct_UClass_ATopDownProjectGameMode, &ATopDownProjectGameMode::StaticClass, TEXT("/Script/TopDownProject"), TEXT("ATopDownProjectGameMode"), false, nullptr, nullptr, nullptr);
